<template>
  <div class="app-container">
    ...
    <el-dialog
      :title="edit ? 'CẬP NHẬT KHUYẾN MÃI' :'THÊM KHUYẾN MÃI'"
    ...
    >
      <el-form :model="form" :rules="rules" ref="form">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Mã khuyến mãi" prop="ma">
          ...
          <el-col :span="12">
            <el-form-item label="Thời gian" prop="thoi_han">
              <el-select
                size="small"
                v-model="form.thoi_han"
                placeholder="Áp dụng cho"
                style="width: 100%"
              >
                <el-option value="vo_thoi_han" label="Không giới hạn"></el-option>
                <el-option value="gioi_han" label="Giới hạn"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="Thời gian áp dụng" prop="thoi_gian">
              <el-date-picker
                :disabled="form.thoi_han == 'vo_thoi_han'"
...
import { addVoucher, voucher, updateVoucher } from "@/api/voucher";
  ...
  methods: {
    showUpdate(data) {
      ...
      if (data.ap_dung_cho == "danh_muc") {
        this.form.danhMucs = Array.from(
          new Set(data.san_phams.map((el) => el.san_pham.danh_muc_id))
        );
        this.form.sanPhams = [];
      }
    },
