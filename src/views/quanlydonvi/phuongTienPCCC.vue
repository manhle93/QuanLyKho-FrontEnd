  ...
  <div class="app-container">
    ...
    <el-row>
      ...
      <el-button
        ...
        >Tìm kiếm</el-button
      >
      <el-tooltip content="Thêm mới phương tiện PCCCC">
        <el-button
          style="background-color: #3498DB; color: white; float: right"
    ...
    <el-row style="margin-top:20px">
      ...
      >
        ...
        <el-table-column
          sortable
          label="Loại phương tiện pccc"
          prop="loai_phuong_tien_pccc.ten"
        ></el-table-column>
        <el-table-column label="Quản lý">
          <template slot-scope="scope">
            <div
              v-if="
                scope.row.don_vi_pccc_quan_ly && scope.row.don_vi_pccc !== null
              "
            >
              {{ scope.row.don_vi_pccc.ten }}
            </div>
            <div v-else-if="scope.row.quan_huyen != null">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Tên phương tiện pccc" prop="ten">
              <el-input
                placeholder="Nhập tên phương tiện pccc"
                v-model="form.ten"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item label="IMEI thiết bị" prop="imei">
              <el-input
                placeholder="Nhập IMEI thiết bị định vị"
                v-model="form.imei"
              ></el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
      ...
      if (data.data.tinhthanh != null) {
        ...
        window.location.assign(
          process.env.VUE_APP_BASE_API +
            "downloadmauphuongtien?tinh_thanh_id=" +
            tinh_thanh_id
        );
      } else {
        window.location.assign(
          process.env.VUE_APP_BASE_API + "downloadmauphuongtien"
        );
      }
    },
    ...
    async destroy(data) {
      try {
        await this.$confirm(
          "Bạn có chắc chắn muốn xóa phương tiện pccc: " +
            "<strong>" +
            data.ten +
            "</strong>",
        ...
        await destroyPhuongTienPccc(data.id);
        this.$message({
