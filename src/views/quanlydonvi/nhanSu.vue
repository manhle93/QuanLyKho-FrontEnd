  ...
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="2" :offset="14">
        <el-button
          type="success"
          style="float:right; background-color: #3498DB; color: white"
          circle
          icon="el-icon-plus"
    ...
    >
            ...
            <el-row :gutter="20">
              <el-col>
                <el-form-item label="Họ tên" prop="ten">
                  <el-input
                    v-model="form.ten"
                    placeholder="Họ tên cán bộ chiến sĩ"
                  />
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="12">
                ...
                >
                  ...
                  <el-select v-model="form.loai_nhan_su" style="width: 100%">
                    <el-option value="phong_ngua" label="Phòng cháy"
                      >Phòng cháy</el-option
                    >
                    <el-option value="cnch" label="Công tác CC&CNCH"
                      >Công tác CC&CNCH</el-option
                    >
                  </el-select>
                </el-form-item>
              </el-col>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="warning" icon="el-icon-close" @click="cancel"
          >Hủy</el-button
        >
        <el-button
          v-if="!edit"
    ...
    >
      ...
      <el-table-column sortable label="Phòng ban">
        <template slot-scope="scope">
          ...
          <div v-else-if="scope.row.quan_huyen != null">
            {{
              scope.row.loai_nhan_su == "phong_ngua"
                ? "Phòng cháy"
                : "Công tác CC&CNCH"
            }}
          </div>
      ...
      if (data.data.tinhthanh != null) {
        ...
        window.location.assign(
          process.env.VUE_APP_BASE_API +
            "downloadmaunhansu?tinh_thanh_id=" +
            tinh_thanh_id
        );
      } else {
        window.location.assign(
          process.env.VUE_APP_BASE_API + "downloadmaunhansu"
        );
      }
    },
    async getInfor() {
