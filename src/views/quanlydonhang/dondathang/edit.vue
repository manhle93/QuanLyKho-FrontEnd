    ...
    >
      <div style="margin-top: 10px">
        ...
        <el-button
          ...
          size="small"
          :class="
            form.trang_thai == 'moi_tao' ||
            form.trang_thai == 'mua_hang_online' ||
            form.trang_thai == 'dat_hang_online'
              ? 'success-button'
              : ''
          "
          @click="
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      if (
        data.data.trang_thai == "mua_hang_online" ||
        data.data.trang_thai == "dat_hang_online"
      ) {
