              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    ...
                    {{
                      scope.row.hang_hoa ? scope.row.hang_hoa.don_vi_tinh : ""
                    }}
                  </template>
                </el-table-column>
                <el-table-column label="Số lượng đổi" width="180px">
                  <template slot-scope="scope">
                    <el-input-number
                      size="small"
                      :min="0"
                      v-model="scope.row.so_luong_doi_tra"
                      :max="scope.row.so_luong_ban_dau"
                    ></el-input-number>
                  </template>
                </el-table-column>
    ...
    >
      <div style="margin-top: 10px">
        ...
        >
          ...
          <!-- <el-form-item label="Nguyên nhân đổi hàng">
            <el-input
              size="small"
              type="textarea"
              v-model="form.nguyen_nhan_doi_hang"
            ></el-input>
          </el-form-item> -->
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        phu_thu: 0,
        nguyen_nhan_doi_hang: "",
        nguyen_nhan_tra_hang: "",
      },
    ...
    submit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (tongDoiTra == 0) {
            this.$message({
              message: "Chưa nhập số lượng hàng đổi trả",
              type: "warning",
            });
            return;
          }
          doiHang(this.$route.params.id, this.form).then((res) => {
            this.$message({
              message: "Thành công",
              type: "success",
            });
