  ...
  <div class="app-container">
    ...
    <el-row>
      <el-form :rules="rules" ref="form" :model="form">
        ...
        <el-col :span="20">
          <el-button icon="el-icon-edit" class="primary-button" v-if="form.trang_thai" @click="submit('form')">CẬP NHẬT</el-button>
...
<script>
import {addBaiViet, chiTietBaiViet, editBaiViet} from "@/api/caidat"
...
this.getBaiViet()
  ...
  methods: {
   async getBaiViet(){
    ...
    this.form.trang_thai = data.xuat_ban
    this.form.tieu_de = data.tieu_de
    this.form.noi_dung = data.noi_dung  
    },
    handleChange(e) {
    ...
    submit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          editBaiViet(this.$route.params.id, this.form).then((res) => {
            this.$message({
              type: "success",
              message: "Thành công",
            });
