    ...
    <el-form ref="form" :model="form" :rules="rules">
      <el-row :gutter="20">
        <el-col :span="22" :offset="1">
          <h4>Thêm mới công tác xử lý vi phạm về PCCC</h4>
          <el-row :gutter="20">
            <el-col :sm="{span:8}">
            ...
            <el-col :sm="{span:8}">
              <el-form-item label="Đối tượng vi phạm" prop="doi_tuong_vi_pham">
                <el-input v-model="form.doi_tuong_vi_pham" placeholder="Nhập đối tượng vi phạm"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :sm="{span:8}">
              <el-form-item label="Nội dung hành vi cụ thể" prop="noi_dung_hanh_vi">
                <el-input v-model="form.noi_dung_hanh_vi" placeholder="Nhập nội dung hành vi"></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="{span:8}">
              <el-form-item label="Nhóm hành vi" prop="so_van_ban">
                <br />
                <el-select multiple v-model="form.nhom_hanh_vi_id" style="width: 100%" filterable>
                  <el-option
            ...
            <el-col :sm="{span:8}">
              ...
              <el-form-item>
                ...
                <el-checkbox size="small" border label="Cảnh cáo" v-model="form.canh_cao"></el-checkbox>
              </el-form-item>
              <el-form-item>
              ...
              <el-form-item>
                <label style="padding-right: 20px">3. Đình chỉ/Tạm đình chỉ:</label>
                <el-radio-group v-model="form.trang_thai_dinh_chi" size="mini">
                ...
                <br />
                <el-date-picker
                  v-if="form.trang_thai_dinh_chi == 'Tạm đình chỉ'"
                  size="small"
              ...
              <el-form-item>
                ...
                <br />
                <el-input v-model="form.xu_ly_khac" placeholder="Nhập nội dung" size="small"></el-input>
              </el-form-item>
              <el-upload
                ref="upload"
                :action="urlUpload"
                ...
                :data="{type_reference:'xu_ly_vi_pham'}"
                :before-upload="beforeUpload"
              >
                <el-button size="small" class="primary-button">Đính kèm tập tin</el-button>
                <div slot="tip" class="el-upload__tip">Đính kèm files với dung lượng nhỏ hơn 20MB</div>
              </el-upload>
            </el-col>
          </el-row>
          <br />
...
<script>
import { getNhomHanhVi, addXuLyViPham } from "@/api/xulyvipham";
