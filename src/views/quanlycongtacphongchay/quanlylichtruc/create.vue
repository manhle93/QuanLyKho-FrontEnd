            ...
            <el-col :sm="{span:5}">
              <el-form-item label="Đơn vị" prop="don_vi_id">
                <el-select
                  ...
                  placeholder="Hãy chọn đơn vị pcc"
                >
                  <el-option
            ...
            <el-col :sm="{span:10}">
              <el-form-item label="Phương tiện PCCC" prop="phuong_tien_pccc_id">
                <el-select
                  ...
                  multiple
                  clearable
                  v-model="form.phuong_tien_pccc_id"
...
import {themlichtruc} from "@/api/lichtruc";
  ...
  created() {
    ...
    getInfor().then(res => {
      if (res.data.tinh_thanh_id && res.data.role_id == 2) {
        ...
        this.changeTinhThanh(res.data.tinh_thanh_id);
      } else {
