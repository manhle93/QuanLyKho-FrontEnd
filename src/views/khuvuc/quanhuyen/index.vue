<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column sortable prop="name" label="Tên quận huyện">
        <template slot-scope="scope">
          <span>{{ scope.row.name }}</span>
        </template>
      </el-table-column>
      <el-table-column sortable prop="name_1" label="Trực thuộc tỉnh thành phố">
        <template slot-scope="scope">
          <span>{{ scope.row.tinh_thanh.name   }}</span>
        </template>
      </el-table-column>
      <el-table-column width="110" align="center" fixed="right" label="Hoạt động">
        <template slot-scope="scope">
