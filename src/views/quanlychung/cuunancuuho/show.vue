    ...
    <el-form ref="form" :model="form" :rules="rules">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-row :gutter="20">
            <el-col :md="{span:12}">
              <el-form-item label="Tên công tác CHCN" label-position="right" prop="ten">
                <el-input v-model="form.ten" placeholder="Nhập tên CHCN"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="{span:12}">
              <el-form-item label="Số điện thoại người báo" label-position="right">
                <el-input v-model="form.so_dien_thoai_nguoi_bao" placeholder="Nhập số điện thoại"></el-input>
              </el-form-item>
            </el-col>
            <el-col :md="{span:12}">
              <el-form-item label="Tên người báo" label-position="right" prop="nguoi_bao">
                <el-input
            ...
            <el-col :md="{span:12}">
              <el-form-item label="Thuộc khu vực" label-position="right" prop="khu_vuc">
                <br />
                <el-select v-model="form.khu_vuc" placeholder="Chọn khu vực" style="width: 100%">
            ...
            <el-col :md="{span:12}">
              <el-form-item label="Nơi xảy ra vụ việc" label-position="right" prop="noi_xay_ra">
                <br />
                <el-select v-model="form.noi_xay_ra" placeholder="Chọn khu vực" style="width: 100%">
                  <el-option value="Khu CN, CX" label="Khu CN, CX"></el-option>
                  <el-option value="Cơ quan, doanh nghiệp" label="Cơ quan, doanh nghiệp"></el-option>
                  <el-option value="Khu dân cư" label="Khu dân cư"></el-option>
                  <el-option value="Khu công cộng" label="Khu công cộng"></el-option>
                  <el-option value="Nhà cao tầng" label="Nhà cao tầng"></el-option>
                  <el-option value="Phương tiện GTVT" label="Phương tiện GTVT"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :md="{span:12}">
            ...
            <el-col :md="{span:12}">
              <el-form-item label="Nguyên nhân" label-position="right" prop="nguyen_nhan">
                <el-input
            ...
            <el-col :md="{span:12}">
              <el-form-item label="Hậu quả khác" label-position="right" prop="hau_qua_khac">
                <el-input
        ...
        <el-col :span="12">
          <el-row :gutter="20">
            ...
            <el-col :md="{span:12}">
              <el-form-item label="Quận huyện" label-position="right" prop="quan_huyen_id">
                <el-select
                  filterable
                  style="width:100%"
...
import { showcnch, updatecnch } from "@/api/cnch";
  ...
  methods: {
    ...
    submit(createToaNha) {
      this.$refs[createToaNha].validate(valid => {
        if (valid) {
          this.loading = true;
          updatecnch(this.$route.params.id, this.form)
            .then(res => {
              this.loading = false;
              this.$message({
